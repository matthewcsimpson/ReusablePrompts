# DB migration review — core

Shared scaffold for the database migration review. Not invoked
directly — the ORM-specific variants
(`db-migration-review.prisma.prompt.md`,
`db-migration-review.alembic.prompt.md`, etc.) reference this file
...
```
# Migration review — <migration id or name>
